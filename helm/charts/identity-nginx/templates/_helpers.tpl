...
{{- if or (and .Values.cloneStaticSiteFromGit .Values.cloneStaticSiteFromGit.enabled) .Values.staticSiteConfigmap .Values.staticSitePVC }}
    {- true -}}
{{- end -}}
{{- end -}}
